...
const queries = {
  ...
  Abramovich: `(Abramovich OR Абрамовіч OR Abramovich) -is:retweet`,
  Usmanov: `(Usmanov OR Усманов OR Usmanov) -is:retweet`,
  Abramov: `(Abramov OR Абрамов OR Abramov) -is:retweet`,
  Prokhorov: `(Prokhorov OR Прокхоров OR Prokhorov) -is:retweet`,
  Sechin: `(Sechin OR Сечин OR Sechin) -is:retweet`
};
